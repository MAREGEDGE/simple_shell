Dominic Marege, Rebecca Nyambura and Elizabeh Njeri
Description
...
Interactive Mode
In interactive mode, simply run the program and wait for the prompt to appear. From there, you can type commands freely, exiting with either
...
Credits
All codes written by [Dominic Marege, Rebecca Nyambura and Elizabeth Njeri]
